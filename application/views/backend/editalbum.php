...
<h3 class="panel-title">album Details </h3>
</header>
<div class="panel-body">
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/editalbumsubmit");?>' enctype= 'multipart/form-data'>
