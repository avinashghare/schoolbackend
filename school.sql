...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2015 at 04:29 PM
...
(1, 'Users', '', '', 'site/viewusers1', 1, 0, 1, 1, 'icon-user'),
(4, 'Dashboard', '', '', 'site/index', 1, 0, 1, 0, 'icon-dashboard'),
(5, 'Users View', '', '', 'site/viewusers', 1, 1, 1, 1, 'icon-user');
...
--
-- Table structure for table `school_album`
--

CREATE TABLE IF NOT EXISTS `school_album` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Table structure for table `school_albumimage`
--

CREATE TABLE IF NOT EXISTS `school_albumimage` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `school_album`
--
ALTER TABLE `school_album`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `school_albumimage`
--
ALTER TABLE `school_albumimage`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `school_album`
--
ALTER TABLE `school_album`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `school_albumimage`
--
ALTER TABLE `school_albumimage`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
